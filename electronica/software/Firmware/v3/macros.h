...
#define RUN_TIMER_1		TCCR1B |=((0<<CS12)|(0<<CS11)|(1<<CS10));
#define STOP_TIMER_1	TCCR1B &=~((1<<CS12)|(1<<CS11)|(1<<CS10));


#define	POS_INC_MODULO(var,TOPE) if( var>=(TOPE-1) ) {var=0;} else {var++;}
	
typedef enum {CORRIENTE_DIRECTA, CORRIENTE_INVERSA} sentido_cte;
